...
function TowerApp() {
  ...
  const { unreadIds: slackUnreadIds, acknowledge: acknowledgeSlack } = useSlackReadState(slack?.events || [], selectedSlackId, !showHelp && !showNewSession && !showAutoPrompt && !(sidebarIsDrawer && sidebarOpen));
