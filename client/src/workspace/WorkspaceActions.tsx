...
/** `note` says why the tools are unavailable, when the reason is not plain from the page. */
export function WorkspaceActions({ cwd, token, disabled = false, note }: { cwd: string; token: string; disabled?: boolean; note?: string }) {
  useI18n();
